...
byte start_address = 1;       // lower addresses are reserved to prevent conflicts with other protocols
byte end_address = 250;       // higher addresses unlock other modes, like 10-bit addressing
